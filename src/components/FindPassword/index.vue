...
export default {
    ...
    methods:{
        handleToVerify(){
            this.axios.get('/api2/users/verify', {
                params: {
                    email: this.email
                }
            })
...
.password_body .password_email button{ position: absolute; top:10px; right: 10px; height:30px; border-radius: 3px; border:none; padding: 5px; }
